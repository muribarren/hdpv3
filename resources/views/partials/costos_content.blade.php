<form method="POST" action="{{ route('procesar')}}" enctype="multipart/form-data">
    ...
    <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded" @if($hdp->rechazado || $hdp->secuencia > 4 || $participante->costos != $loged_user->id ) style="display:none;" @endif>Enviar</button>
